...
<header class="s-bg-main border-bottom shadow-sm">
    <nav class="container-fluid d-flex align-items-center justify-content-between py-2 px-3">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="<?= \yii\helpers\Url::to(Yii::$app->homeUrl) ?>" class="d-flex gap-2 align-items-center text-decoration-none text-white">
        ...
        <div class="d-flex align-items-center text-decoration-none gap-3">
            <?php if (\Yii::$app->user->isGuest): ?>
                <a href="<?= \yii\helpers\Url::to('/site/login') ?>" class="text-white text-decoration-none">Login</a>
                <a href="<?= \yii\helpers\Url::to('/site/signup') ?>" class="text-white text-decoration-none">Signup</a>
            <?php else: ?>
                <div class="dropdown">
                    <a href="#" class="d-flex gap-2 align-items-center text-white text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow">
                        ...
                        <li>
                            <a class="dropdown-item py-2" href="<?= \yii\helpers\Url::to(['/profile/edit']) ?>"><i class="fa-solid fa-user-pen me-2"></i> Edit Profil</a>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item py-2 text-danger" href="<?= \yii\helpers\Url::to(['/site/logout']) ?>" data-method="post">
