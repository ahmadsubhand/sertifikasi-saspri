...
<div class="d-flex flex-column align-items-start gap-3">
  ...
  <div class="card p-3 d-flex flex-column gap-2 w-100">
    ...
    <div class="d-flex flex-column gap-2">
      ...
      <form id="add-members-form" method="post" action="<?= \yii\helpers\Url::to(['saspri-k/tambah-anggota-tim-mandiri']) ?>">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  input.addEventListener('input', function() {
    ...
    timeout = setTimeout(() => {
      fetch('<?= \yii\helpers\Url::to(['saspri-k/cari-anggota-tim-mandiri']) ?>?q=' + encodeURIComponent(q))
