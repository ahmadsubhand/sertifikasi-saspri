            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">Kandang Saya</h4>
                                <!-- Menampilkan total badge (opsional, bagus untuk UX) -->
                                <span class="badge bg-primary rounded-pill"><?= $cage ?> Kandang</span>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless mb-0">
                                        <?php if (!empty($cages)): ?>
                                            ...
                                            <tbody>
                                                <?php $counter = 1; ?>
                                                <?php foreach ($cages as $cageItem): ?>
                                                <tr>
                                                    <td class="text-bold-500"><?= $counter++ ?></td>
                                                    <td class="text-bold-500 post"><?= $cageItem->name ?></td>
                                                    <td><?= $cageItem->location ?></td>
                                                    <td><?= $cageItem->getLivestockCount() . '/' . $cageItem->capacity ?></td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        <?php else: ?>
                                            <p class="text-muted mt-3">Anda belum memiliki kandang.</p>
                                        <?php endif; ?>
                                    </table>
                                </div>
                            </div>
                            <!-- Tombol Lihat Semua muncul jika data lebih dari 0 -->
                            <?php if ($cage > 0): ?>
                            <div class="card-footer border-top text-center">
                                <a href="<?= Url::to(['/cage/index']) ?>" class="btn btn-light-primary btn-sm w-100">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">Sapi Saya</h4>
                                <span class="badge bg-success rounded-pill"><?= $sapi ?> Ekor</span>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-bold-500">
                                                        <!-- Menjadikan VID dapat diklik untuk trigger modal -->
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modalView<?= $livestock->id ?>">
                                                            <?= $livestock->vid ?>
                                                        </a>
                                                    </td>
                                                    <td class="text-bold-500"><?= $livestock->name ?></td>
                                                    <td class="text-bold-500"><?= $livestock->cage->name ?></td>
                                                    <td class="text-bold-500"><?= $livestock->age ?> thn</td>
                                                </tr>
                                                
                                                <!-- Modal View (Digeser ke bawah kolom agar tidak merusak struktur <tr>) -->
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalViewLabel<?= $livestock->id ?>">Detail Sapi: <?= $livestock->name ?></h5>
                                        ...
                                        <?php else: ?>
                                            <p class="text-muted mt-3">Anda belum memiliki Sapi.</p>
                                        <?php endif; ?>
                                    </table>
                                </div>
                            </div>
                            <!-- Tombol Lihat Semua Sapi -->
                            <?php if ($sapi > 0): ?>
                            <div class="card-footer border-top text-center">
                                <a href="<?= Url::to(['/livestock/index']) ?>" class="btn btn-light-success btn-sm w-100">
                                    Lihat Selengkapnya <i class="bi bi-arrow-right"></i>
                                </a>
                            </div>
                            <?php endif; ?>
