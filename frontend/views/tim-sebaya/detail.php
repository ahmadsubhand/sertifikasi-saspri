...
<div class="page-cont w-100 h-100 p-3 d-flex flex-column gap-3">
  <div class="d-flex align-items-center text-center">
    <a href="/tim-sebaya" class=" text-decoration-none text-black fs-5 me-3">
    ...
    <div class="col-sm-4">
      <div class="bg-white px-2 py-4 rounded-2 shadow border-1 border">
        ...
        <?php elseif (str_contains(strtolower($cert['status']), 'review')) : ?>
          ...
          <div>
            <?php if(in_array(Yii::$app->user->id, array_column($peer_team, 'user_id'))) :?>
            <?= str_contains(strtolower($cert['status']), 'peer') ? Html::a('Mulai Peer Review', ['tim-sebaya/peer-review', 'certification_id' => $cert['id']], [
