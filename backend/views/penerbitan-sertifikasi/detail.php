...
$this->title = (string)'External Review '. $saspri->region_name;
?>

<div class="page-cont w-100 h-100 p-md-3 d-flex flex-column gap-3">
  <div class="d-flex align-items-center text-center">
    <a href="/penerbitan-sertifikasi" class=" text-decoration-none text-black fs-5 me-3">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="bg-white px-2 py-4 rounded-2 shadow border-1 border mt-md-0 mt-3">
