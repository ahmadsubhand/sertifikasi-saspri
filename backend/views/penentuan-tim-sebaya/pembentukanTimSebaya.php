...
<div class="page-cont w-100 h-100 p-md-3 d-flex flex-column gap-3 w-100">
  <h1><?= Html::encode($this->title) ?></h1>

  <div class="bg-white px-2 py-4 rounded-2 shadow border-1 border">
    <div class="px-md-4 px-2">
      <p class="h6 h5 mb-3 border-bottom pb-2">Informasi SASPRI-K</p>
  ...
  <div class="bg-white px-2 py-4 rounded-2 shadow border-1 border">
    <div class="px-4">
        ...
        <table class="table align-middle mt-3">
          <thead>
            <tr>
              ...
              <th scope="col" style=" min-width: 150px;">SASPRI-K</th>
              <th scope="col" style=" min-width: 150px;">Peran</th>
      ...
      <div class="mt-3 d-flex justify-content-between flex-column-reverse flex-md-row">
        <button type="button" class=" btn btn-danger me-2 mb-3 width-full-none" data-bs-toggle="modal" data-bs-target="#rejectModal">Tolak Sertifikasi</button>
        <?= Html::beginForm(['ajukan-peer-review', 'certification_id' => $certification->id], 'post') ?>
        <button type="submit" class=" btn s-btn-green me-2 mb-3 width-full-none"
